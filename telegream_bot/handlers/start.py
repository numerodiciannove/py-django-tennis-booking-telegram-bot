...
async def get_start(message: Message, bot: Bot):
    ...
    if not user:
        hello_text = (
            ...
            f"Мене звати '🎾🏀🏐 PO  BOOKING  BOT'.\n\n"
            f"Я бот який допомогає робити бронювання спорт локацій в 'ЖК Паркові Озера' міста Київ "
            f"за датою та часом. У майбутньому я зможу допомогати "
            f"тобі у пошуку напарників по сусідству та напам'ятати про твої бронювання.\n\n"
